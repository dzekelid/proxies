...
- name: Google Compute Engine API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/proxy/master/_listings/google-compute-engine/project-global-targethttpproxies-targethttpproxy-delete.md
x-common:
- type: x-code
