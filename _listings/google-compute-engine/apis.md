...
- name: Google Compute Engine API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/proxy/master/_listings/google-compute-engine/project-targethttpsproxies-targethttpsproxy-seturlmap-post.md
x-common:
- type: x-code
